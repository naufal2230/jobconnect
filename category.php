                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Drive brand awareness and shape consumer behavior with creative strategies that make an impact.</p>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Be the voice of the company — solve problems, build trust, and create memorable customer experiences.</p>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Empower people, build great teams, and shape workplace culture with meaningful HR strategies.</p>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Lead with vision, manage with precision — deliver projects on time and with excellence.</p>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Spot opportunities, forge partnerships, and scale new heights — your growth mindset starts here.</p>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Connect with people, close the deal — turn conversations into conversions with confidence.</p>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Inspire, guide, and shape the future — share your knowledge and empower the next generation.</p>
                        </a>
                    </div>
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                        <a class="cat-item rounded p-4" href="">
                            ...
                            <p class="mb-0">Turn imagination into visuals — craft experiences through design, art, and innovation.</p>
                        </a>
                    </div>
                </div>
            </div>
