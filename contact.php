                ...
                <div class="row g-4">
                        ...
                        <div class="row gy-4">
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.1s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>56 Imam Bonjol Street, Central Jakarta, Indonesia</span>
                                </div>
                            </div>
                            <div class="col-md-4 wow fadeIn" data-wow-delay="0.3s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <span>supprot@jobconnect.id</span>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <p class="mb-4">Looking for the perfect part-time opportunity? Need more details about how we connect talents to jobs? Our team is ready to assist you.

Feel free to reach out to us by filling out the form — whether you have questions, suggestions, or just want to say hello. We’ll get back to you as soon as possible. <a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                            <form>
                                <div class="row g-3">
                                    <div class="col-md-6">
